...
* В обычном режиме вставленные компоненты можно повернуть на 90° по часовой стрелке. Для этого нужно вставить компоненты и вызвать контекстное меню, нажав **ПРАВУЮ** кнопку мышки (при этом должно быть включено дефолтное контекстное меню сцены). Либо можно вставить компонент и нажать **Пробел**.

  <img src="images/show_rotation_of_pasted_components.gif" alt="Вращение на 90° по часовой стрелке вставленных компонентов" style="zoom:50%;" />
...
* Рисовать точку с помощью контекстного меню (при этом должно быть включено дефолтное контекстное меню сцены) или кликом **ПРАВОЙ** кнопки мышки с нажатой клавишей **Shift**.
...
* Рисовать точку с помощью контекстного меню (при этом должно быть включено дефолтное контекстное меню сцены) или кликом **ПРАВОЙ** кнопки с нажатой клавишей **Shift**.
* Рисовать прямоугольник зажатой **ПРАВОЙ** кнопкой мышки.
