...
* Можно задать режим, при котором выделенный зажатой правой кнопкой мышки прямоугольник останется видимым после того, как правая кнопка мышки будет освобождена. Для этого нужно вызвать метод:
  ...
  ```
* В обычном режиме вставленные компоненты можно повернуть на 90° по часовой стрелке. Для этого нужно вставить компоненты и вызвать контекстное меню, нажав **ПРАВУЮ** кнопку мышки. Либо можно вставить компонент и нажать **Пробел**.
...
* Рисовать точку с помощью контекстного меню или кликом **ПРАВОЙ** кнопки мышки с нажатой клавишей **Shift**.
...
* Рисовать точку с помощью контекстного меню или кликом **ПРАВОЙ** кнопки с нажатой клавишей **Shift**.
* Рисовать прямоугольник зажатой **ПРАВОЙ** кнопкой мышки.
